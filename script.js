...
let favoriteFoods = ["Pasta", "Mango", "Steak", "Tacos", "Ribs", "Kiwi"];
...
// ...etc.
let foodRankings = ["Pasta", "Steak", "Mango", "Ribs", "Tacos", "Kiwi"];
for (let i = 0; i < foodRankings.length; i++) {
  console.log("My #" + (i + 1) + " favorite food is " + foodRankings[i] + ".");
}
